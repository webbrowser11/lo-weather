...
last_updated = "June 19th, 2026 at 3:20 PM PT"
temp_last_updated = "June 19th, 2026 at 3:20 PM PT"
observations_last_updated = "June 19th, 2026 at 3:20 PM PT"
...
def temperature():
    ...
    return jsonify({
        "temperature-high-lake-oswego": 89,
        "temperature-low-lake-oswego": 55,
...
def alerts():
    ...
    return jsonify({
        "alerts-lake-oswego":
        "AN EXTREME HEAT WATCH IS IN EFFECT FROM JUNE 22, 11:00 AM PDT UNTIL JUNE 23, 11:00 PM PDT\nAN EXTREME DROUGHT WATCH CONTINUES FOR THE ENTIRE STATE OF OREGON."
    })
...
def observations():
    return jsonify({
        "observations-lake-oswego": "84 degrees Fahrenheit, Sunny.",
